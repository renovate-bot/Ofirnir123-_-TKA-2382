...
--      pawolf    06/20/2016 - In emit_page_data: changed interface to accept page alias
--      pawolf    08/09/2017 - In validate_browser_property: make use of new wwv_flow_exec_dev.check_and_describe
--      pawolf    08/18/2017 - In validate_browser_property: added p_optimizer_hint
--      pawolf    11/15/2017 - Added emit_workspace_data
--      pawolf    12/20/2017 - In validate_browser_property: added support for POST_PROC_* properties
--      pawolf    08/02/2018 - In emit_db_objects: added p_remote_server_id to support for remote SQL (bug #28446093)
--
--------------------------------------------------------------------------------
