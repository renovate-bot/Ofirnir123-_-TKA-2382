...
--     cbcho    07/16/2018 - In create_region_plugin: added p_region_css_classes (feature #2353)
--                         - In create_query_region: added extra parameters for query table and region attributes (feature #2353)
--                         - added t_lov_list, create_md_side_by_side (feature #2353)
--                         - added overloaded create_md_side_by_side to call from create app wizard (feature #2353)
--     cbcho    07/18/2018 - added additional attribute in t_md for side by side md to use (feature #2353)
--     cbcho    07/19/2018 - added create_dashboard_page (feature #2229)
--
------------------------------------------------------------------------------------------------------------------------------------------------
...
procedure create_md_side_by_side (
    ...
    p_master                    in t_md,
    p_detail_1                  in t_md,
    p_detail_2                  in t_md default null,
    p_detail_3                  in t_md default null,
    p_detail_4                  in t_md default null,
    --
    p_tab_set                   in varchar2 default null,
    p_tab_name                  in varchar2 default null,
    p_tab_text                  in varchar2 default null,
