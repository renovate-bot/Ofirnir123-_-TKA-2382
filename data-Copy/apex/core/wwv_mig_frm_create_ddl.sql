...
Rem    cneumuel     09/18/2015 - Dropped redundant indexes wwv_mig_proj_comp_uk1, wwv_mig_proj_trig_uk1 (bug #20263242)
Rem    cneumuel     07/05/2018 - Do not set sqlplus feedback/echo
