...
--      pawolf   10/29/2015 - In show: added parameter p_component_template_options (feature #1880)
--      cneumuel 11/05/2015 - Added get_format_mask (bug #14111954)
--      xhu      07/28/2016 - Added p_tiny option to get_since and its variants (feature #1966)
--      xhu      08/01/2016 - renamed p_tiny option in get_since to p_short
--      cczarski 08/05/2016 - In row_template_type: Added support for report template CSS Files, JS Files and Onload JS (Feature #2042)
--      cczarski 09/21/2016 - removed output of report template CSS File URLs; will be emitted in wwv_flow_page
--      cczarski 07/24/2017 - added "render_classic_report" as default entry point and removed "show"
--
--------------------------------------------------------------------------------
