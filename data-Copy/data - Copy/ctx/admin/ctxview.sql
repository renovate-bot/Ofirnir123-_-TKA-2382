Rem $Header: ctx_src_2/src/dr/admin/ctxview.sql /main/49 2017/04/19 11:23:10 boxia Exp $
Rem
Rem
Rem ctxview.sql
Rem
...
Rem      SQL_SOURCE_FILE: ctx_src_2/src/dr/admin/ctxview.sql 
Rem      SQL_SHIPPED_FILE: ctx/admin/ctxview.sql
...
Rem    nspancha    03/06/17 - Adding the context2 type to idx_type
Rem    boxia       01/17/17 - Bug 25390928: add ixp_auto_opt_type,
Rem                           ixp_auto_opt_interval
Rem                           to ctx_index_partitions, ctx_user_index_partitions
Rem    boxia       11/19/16 - Bug 25172618: add col idx_auto_opt_type,
Rem                           idx_auto_opt_interval to ctx_indexes,
Rem                           ctx_user_indexes
...
Rem    rkadwe      07/09/12 - Create view to list out all sections for all Text
Rem                           indices
Rem    ssethuma    04/25/12 - Bug 13901327
Rem    rkadwe      11/09/11 - Change CTX_ALEXER_DICTS defn
Rem    pyam        06/06/11 - Consolidation: make later-replaced objs local
Rem    ssethuma    03/24/11 - section specific attributes
Rem    hsarkar     03/24/11 - Date and Pattern Stopclass project
Rem    rpalakod    02/07/11 - filter cache
Rem    rpalakod    07/28/09 - autooptimize
Rem    nenarkhe    06/29/09 - add dr0tree package
Rem    nenarkhe    04/23/09 - remove dr$mvdata_update
Rem    rpalakod    02/05/08 - Bug 6798472: ctx_user_extract_policies
Rem    rpalakod    12/28/07 - new dictionary
Rem    rpalakod    12/28/07 - user_extract_rule
Rem    rpalakod    11/14/07 - Entity Extraction Views: Part 3
Rem    rpalakod    10/19/07 - second set of entity extraction views
Rem    rpalakod    10/16/07 - first set of entity extraction views
Rem    wclin       05/11/07 - bug5996259: support sql92 security
Rem    wclin       05/08/07 - SDATA section support CHAR type
Rem    wclin       08/11/06 - bug5401928: fix pending view hints
Rem    skabraha    07/18/06 - add idx_query_stats_enabled to ctx*indexes
Rem    wclin       07/13/06 - add section id to cdi views 
Rem    rigandhi    06/07/06 - name search 
Rem    wclin       05/17/06 - add cdi orderby col sort order 
Rem    ymatsuda    02/17/06 - sdata section datatype 
