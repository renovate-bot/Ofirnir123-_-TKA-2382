...
Rem      SQL_SOURCE_FILE: ctx_src_2/src/dr/admin/d0902000.sql 
Rem      SQL_SHIPPED_FILE: ctx/admin/d0902000.sql
...
Rem    gkaminag    09/01/05 - rio downgrade 
Rem    surman      06/03/05 - 4403693: Only delete Japanese stemmer attributes 
...
REM 4403693: Add oal_value to where clause
REM ========================================================================

delete from dr$object_attribute_lov
  where oal_oat_id = 70101 and oal_value = 10;
delete from dr$object_attribute_lov
  where oal_oat_id = 70102 and oal_value = 13;
commit;
