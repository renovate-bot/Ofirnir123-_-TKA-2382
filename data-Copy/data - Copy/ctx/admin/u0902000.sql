...
Rem      SQL_SOURCE_FILE: ctx_src_2/src/dr/admin/u0902000.sql
Rem      SQL_SHIPPED_FILE: ctx/admin/u0902000.sql
...
Rem    surman      03/08/06 - 5057216: Handle constraint violation for 
Rem                           OUTPUT_FORMATTING 
...
exception
  when dup_val_on_index then
    null;  -- 5057216: This attribute could already be present since 9.2.0.7
end;
/
