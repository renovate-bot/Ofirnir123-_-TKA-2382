...
@set TNS_ADMIN=
@set ORACLE_HOME=%OH%
@set JRE_CLASSPATH=C:\WINDOWS.X64_193000_db_home\jdk\jre\lib\rt.jar
@set JRE_EXT_CLASSPATH=C:\WINDOWS.X64_193000_db_home\jdk\jre\lib\ext\sunjce_provider.jar
@set I18N_CLASSPATH=C:\WINDOWS.X64_193000_db_home\jdk\jre\lib\i19n.jar
...
"C:\WINDOWS.X64_193000_db_home\jdk\jre\BIN\JAVA" -DDEV_MODE=false -DTRACING.ENABLED=true -DTRACING.TOFILE=true -DTRACING.LEVEL=2 -DORACLE_HOME="%OH%" -Doracle.installer.not_bootstrap=true -mx128m oracle.sysman.assistants.rconfig.RConfig  %*
:End
exit /B %ERRORLEVEL%
