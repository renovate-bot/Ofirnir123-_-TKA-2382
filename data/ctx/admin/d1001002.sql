Rem
Rem $Header: ctx_src_2/src/dr/admin/d1001002.sql /main/15 2018/07/25 13:49:08 surman Exp $
Rem
Rem d1001002.sql
Rem
...
Rem      SQL_SOURCE_FILE: ctx_src_2/src/dr/admin/d1001002.sql 
Rem      SQL_SHIPPED_FILE: ctx/admin/d1001002.sql
...
Rem    gkaminag    10/06/05 - create empty index implementation type on 
Rem                           downgrade 
Rem    daliao      04/04/05 - remove odm static link
...
REM ========================================================================
REM ctx_centroids type
REM ========================================================================

drop public synonym ctx_centroids;   
drop type ctx_centroids;
drop type ctx_centroid;
