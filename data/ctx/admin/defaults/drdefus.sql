Rem
Rem $Header: ctx_src_2/src/dr/admin/defaults/drdefus.sql /main/13 2018/08/08 15:49:32 nspancha Exp $
Rem
Rem drdefus.sql
Rem
...
Rem    nspancha    05/01/18 - Bug 27084954: Safe Schema Loading
...
begin
  ...
  CTX_DDL.set_attribute('CTXSYS.DEFAULT_WORDLIST','STEMMER', 'ENGLISH');
...
begin
  CTX_DDL.create_stoplist('CTXSYS.EXTENDED_STOPLIST');
