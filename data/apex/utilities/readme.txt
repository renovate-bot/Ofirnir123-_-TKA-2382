...
------------------------------------
  ...
  APEXExportSplitter.class   - DEPRECATED.
                               Java program used to split Oracle Application
                               Express export files into separate SQL scripts.
...
NOTE:
  ...
  APEXExportSplitter has been deprecated. Use the -split parameter of APEXExport
  instead.
