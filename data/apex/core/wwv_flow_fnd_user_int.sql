...
--     cneumuel 02/22/2016 - Added can_delete_user (bug #22655596)
--     cneumuel 04/01/2016 - In create_company: export p_clone_session_yn (feature #1154)
--     cneumuel 07/06/2016 - In create_company: removed p_clone_session_yn
--     cneumuel 07/13/2016 - Added authenticate, get_groups_of_user (bug #23030319)
--     cneumuel 10/09/2017 - In export_fnd_users: added p_with_date (feature #2224)
--     jstraub  12/05/2017 - In create_company: export p_webservice_logging_yn and p_max_webservice_requests (feature #2233)
--     cczarski 12/18/2017 - In create_company: export p_content_cache_target_size and p_content_cache_max_file_size (feature #2092, #2109)
--     cneumuel 07/25/2018 - Added get_user (bug #28102037)
--
--------------------------------------------------------------------------------
...
type t_account_privileges is record (
    account_type         wwv_flow_workspace_user_api.t_account_type,
    app_builder          boolean,
    websheets            boolean,
...
--==============================================================================
-- return whether a user can be deleted. this is disabled if the developers are
-- managed externally, as it is done in the cloud. a user also can not delete
-- herself.
--==============================================================================
...
--==============================================================================
-- Return all (recursively) assigned groups of the given user.
--
-- PARAMETERS
-- * p_security_group_id:          Security group id
...
--
-- EXAMPLE
--   Print groups assigned to user BUD in workspace with sgid 1234567890
--
--   declare
--       l_groups apex_t_varchar2;
--   begin
--       l_groups := wwv_flow_fnd_user_int.get_assigned_groups (
--                       p_security_group_id => 1234567890,
--                       p_user_name         => 'BUD' );
--       for i in 1 .. l_groups.count loop
--           sys.dbms_output.put_line(i||':'||l_groups(i));
--       end loop;
--   end;
--==============================================================================
...
--==============================================================================
-- Return workspace user information for the given user/workspace.
--
-- PARAMETERS
...
--
-- RETURNS
--   The user record. If the given user is not a workspace user, only user_name
--   and security_group_id are populated.
--
-- EXAMPLE
--   Print email address of JOHN DOE in workspace 1234.
--
--   declare
--       l_user wwv_flow_workspace_user_api.t_user;
--   begin
--       l_user := wwv_flow_fnd_user_int.get_user (
--                     p_security_group_id => 1234,
--                     p_user_name         => 'JOHN DOE' );
--       sys.dbms_output.put_line(l_user.email_address);
--   end;
--==============================================================================
function get_user (
    p_security_group_id in number,
    p_user_name         in varchar2 )
    return wwv_flow_workspace_user_api.t_user;

--==============================================================================
-- Implementation of wwv_flow_workspace_user_api.authenticate - see spec
--==============================================================================
function authenticate (
    p_user_name in varchar2,
    p_password  in varchar2,
    p_workspace in varchar2,
    p_current_user in varchar2  default sys_context('userenv','current_user') )
    return wwv_flow_workspace_user_api.t_authentication_result;
