...
--------------------------------------------------------------------------------
--
--  Copyright (c) Oracle Corporation 2010-2018. All Rights Reserved.
--
--    NAME
--      wwv_flow_debug.sql
--
...
--     cneumuel 10/16/2015 - In log_exception: add p_force
--     cneumuel 04/21/2016 - Added enable_dbms_output, disable_dbms_output. In do_insert_message: emit with dbms_output.
--     cneumuel 04/26/2016 - In enable_dbms_output: default prefix is '# APEX:'
--     cneumuel 07/14/2016 - Changed wwv_flow_debug.enable_cache to wwv_flow_debug.configure_cache
--     cneumuel 10/02/2017 - In enter: added p_{name,value}{11,12}
--     cneumuel 02/06/2018 - In enter: added p_{name,value}{13}
--     cczarski 10/07/2018 - Add log_vc_array to log SQL statements as wwv_flow_global.vc_arr2
--
--------------------------------------------------------------------------------
