...
--    pawolf      04/18/2016 - In save_by_id, save_by_name: added p_external_input parameter
--    cneumuel    07/15/2016 - explicit !escaping for items with input filtering set to Y (bug #24303391)
--    cneumuel    11/17/2016 - In fetch_value_by_id: add p_use_cache (bug #25112763)
--    cneumuel    12/05/2017 - Added overloaded do_exact_item_substitutions, do_substitutions, do_raw_substitutions, do_html_substitutions with p_skip_items (bug #25651611)
--    cneumuel    01/10/2018 - Added clear_all_state_for_name_aut (bug #26304637)
--    cneumuel    02/22/2018 - In t_substitution_applier,init_applier: removed redundant p_(start|end)_char (bug #27131471)
--    pawolf      03/01/2018 - Made escape_value a public function
--
--------------------------------------------------------------------------------
