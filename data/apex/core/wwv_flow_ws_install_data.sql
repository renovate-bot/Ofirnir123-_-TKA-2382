...
Rem      cneumuel    09/21/2016 - Enclosed ddl in PL/SQL blocks, to reduce noise in install log
Rem      hfarrell    01/29/2018 - Added chart_orientation column, removed chart_3d (18.1 feature #1841)
Rem      cbcho       02/15/2018 - In apex$_ws_files trigger removed auto populate image_alias (bug #27257560)
Rem      hfarrell    02/20/2018 - Removed apex$_ws_webpg_section_3d_ck constraint (feature #1841, bug #27569556)
...
insert into wwv_flow_ws_tables(id,table_name,install_seq,drop_seq,has_triggers,has_constraints,ddl) values(2,'APEX$_WS_WEBPG_SECTIONS',20,20,'Y','Y',
     ...
     'chart_orientation       varchar2(10 byte),'||chr(10)||
     --
...
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(22,'APEX$_WS_WEBPG_SECTIONS','CHART_LABEL','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(23,'APEX$_WS_WEBPG_SECTIONS','LABEL_AXIS_TITLE','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(24,'APEX$_WS_WEBPG_SECTIONS','CHART_VALUE','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(25,'APEX$_WS_WEBPG_SECTIONS','VALUE_AXIS_TITLE','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(26,'APEX$_WS_WEBPG_SECTIONS','CHART_AGGREGATE','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(27,'APEX$_WS_WEBPG_SECTIONS','CHART_SORTING','VARCHAR2','255','Y');
insert into wwv_flow_ws_tab_columns( id,table_name,column_name,data_type,data_length,nullable ) values(28,'APEX$_WS_WEBPG_SECTIONS','CHART_ORIENTATION','VARCHAR2','10','Y');
...
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(6,'APEX$_WS_ROWS','APEX$_WS_ROWS_PK','P','ID',null,null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(7,'APEX$_WS_NOTES','APEX$_WS_NOTES_PK','P','ID',null,null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(8,'APEX$_WS_NOTES','APEX$_WS_NOTES_FK','R','ROW_ID',null,'APEX$_WS_ROWS','ID','CASCADE');
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(9,'APEX$_WS_NOTES','APEX$_WS_NOTES_CL_CK','C','COMPONENT_LEVEL','component_level in (''WEBSHEET'',''ROW'',''WORKSPACE'',''WEBPAGE'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(10,'APEX$_WS_LINKS','APEX$_WS_LINKS_PK','P','ID',null,null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(11,'APEX$_WS_LINKS','APEX$_WS_LINKS_FK','R','ROW_ID',null,'APEX$_WS_ROWS','ID','CASCADE');
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(12,'APEX$_WS_LINKS','APEX$_WS_LINKS_CL_CK','C','COMPONENT_LEVEL','component_level in (''WEBSHEET'',''ROW'',''WORKSPACE'',''WEBPAGE'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(13,'APEX$_WS_LINKS','APEX$_WS_LINKS_SH_CK','C','SHOW_ON_HOMEPAGE','show_on_homepage in (''Y'',''N'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(14,'APEX$_WS_TAGS','APEX$_WS_TAGS_PK','P','ID',null,null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(15,'APEX$_WS_TAGS','APEX$_WS_TAGS_FK','R','ROW_ID',null,'APEX$_WS_ROWS','ID','CASCADE');
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(16,'APEX$_WS_TAGS','APEX$_WS_TAGS_CL_CK','C','COMPONENT_LEVEL','component_level in (''WEBSHEET'',''ROW'',''WORKSPACE'',''WEBPAGE'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(17,'APEX$_WS_FILES','APEX$_WS_FILES_PK','P','ID',null,null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(18,'APEX$_WS_FILES','APEX$_WS_FILES_FK','R','ROW_ID',null,'APEX$_WS_ROWS','ID','CASCADE');
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(19,'APEX$_WS_FILES','APEX$_WS_FILES_CL_CK','C','COMPONENT_LEVEL','component_level in (''WEBSHEET'',''ROW'',''WORKSPACE'',''WEBPAGE'')',null,null,null);
-- new constraint added in 4.2
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(20,'APEX$_WS_WEBPG_SECTIONS','APEX$_WS_WEBPG_SECTION_AR_CK','C','SHOW_ADD_ROW','show_add_row in (''Y'',''N'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(21,'APEX$_WS_WEBPG_SECTIONS','APEX$_WS_WEBPG_SECTION_ER_CK','C','SHOW_EDIT_ROW','show_edit_row in (''Y'',''N'')',null,null,null);
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(22,'APEX$_WS_WEBPG_SECTIONS','APEX$_WS_WEBPG_SECTION_SER_CK','C','SHOW_SEARCH','show_search in (''Y'',''N'')',null,null,null);
-- new constraint added in 5.0
insert into wwv_flow_ws_constraints( id,table_name,constraint_name,constraint_type,column_name,search_condition,r_table_name,r_column_name,delete_rule ) values(23,'APEX$_WS_ROWS','APEX$_WS_ROWS_UK1','U','WS_APP_ID, DATA_GRID_ID, UNIQUE_VALUE',null,null,null,null);
end;
/
