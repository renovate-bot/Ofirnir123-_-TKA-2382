...
create table wwv_flow_standard_icons(
    ...
    icon_library  varchar2(20)  not null
                  ...
                  check ( icon_library in ( 'APEX','FONTAWESOME','FONTAPEX','FONTAPEX_LATEST')),
...
create table wwv_flows (
    ...
    compatibility_mode            varchar2(3) default '4.0'
                                  ...
                                  check (compatibility_mode in ('4.0', '4.1', '4.2', '5.0', '5.1')),
...
create table wwv_credentials (
    ...
    authentication_type varchar2(25) not null
                        constraint wwv_credential_auth_type_ck
                        check ( authentication_type in ( 'BASIC', 'OAUTH2_CLIENT_CREDENTIALS', 'JWT' )),
...
create table wwv_credential_instances (
    ...
    value_type        varchar2(13) not null
                      constraint wwv_cred_instance_type_ck
                      check ( value_type in ( 'CLIENT_ID', 'CLIENT_SECRET', 'ACCESS_TOKEN', 'REFRESH_TOKEN', 'ID_TOKEN' )),
    value             varchar2(4000) not null,
    expiry_date       date
)
/
...
create table wwv_flow_web_src_modules (
    ...
    web_source_type                varchar2(11) not null
                                   ...
                                   check ( web_source_type in ( 'SOAP', 'ORDS_2', 'ORDS_3', 'HTTP_FEED', 'ADFBC', 'CUSTOM' )),
    data_profile_id                number not null
...
/
alter table wwv_flow_web_src_operations add constraint wwv_websrc_opers_dboper_uk unique (flow_id, web_src_module_id, database_operation)
/
...
create table wwv_flow_themes (
     ...
     icon_library                varchar2(255)
                                 ...
                                 check ( icon_library in ( 'FONTAWESOME', 'FONTAPEX', 'FONTAPEX_LATEST' ) ),
...
create table wwv_flow_authentications (
    ...
    credential_id                                       number generated always as (
                                                                   case
                                                                   when scheme_type='NATIVE_SOCIAL' then to_number(attribute_01)
                                                                   end ) virtual,
    --
...
create table wwv_flow_jet_chart_series (
       ...
       items_label_position         varchar2(15)
                                    ...
                                    check (items_label_position in ('center','outsideSlice','aboveMarker','belowMarker','beforeMarker','afterMarker','insideBarEdge','outsideBarEdge','auto','none')),
       items_label_display_as       varchar2(7)
                                    constraint jet_series_label_display_as
                                    check (items_label_display_as in ('LABEL','VALUE','PERCENT','ALL','COMBO')),
