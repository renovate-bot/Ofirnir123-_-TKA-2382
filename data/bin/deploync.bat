...
@echo  "----------------------------------------------------------------------"
@echo on
%JAVA_HOME%\bin\java -Xint -DJA_HOME=%JA_HOME% -DORACLE_HOME=C:\WINDOWS.X64_193000_db_home -DJA_LIBS_HOME=C:\WINDOWS.X64_193000_db_home -DJAVA_HOME=%JAVA_HOME% -DJAVA_HOME_CLASSPATH=%JAVA_HOME_CLASSPATH% -classpath %JACLASSPATH% oracle.jaccelerator.Deploy %args% 
@echo off
goto finish
