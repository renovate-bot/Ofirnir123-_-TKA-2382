...
@set JRE_DIR=C:\WINDOWS.X64_193000_db_home\jdk\jre
@set JLIB_DIR=C:\WINDOWS.X64_193000_db_home\jlib
...
@set ASSISTANTS_COMMON_JAR=C:\WINDOWS.X64_193000_db_home\assistants\jlib\assistantsCommon.jar
@set NETCA_JAR=C:\WINDOWS.X64_193000_db_home\assistants\netca\jlib\netca.jar
@set INSTALLER_JAR=C:\WINDOWS.X64_193000_db_home\oui\jlib\OraInstaller.jar
@set PREREQ_JAR=C:\WINDOWS.X64_193000_db_home\oui\jlib\OraPrereq.jar
@set PREREQ_CHECKS_JAR_1=C:\WINDOWS.X64_193000_db_home\oui\jlib\OraPrereqChecks.jar
@set PREREQ_CHECKS_JAR_2=C:\WINDOWS.X64_193000_db_home\inventory\prereq\oui\OraPrereqChecks.jar
@set SRVM_JAR=%JLIB_DIR%\srvm.jar
@set SRVMHAS_JAR=%JLIB_DIR%\srvmhas.jar
@set SRVMASM_JAR=%JLIB_DIR%\srvmasm.jar
@set SUPERCLUSTER_JAR=C:\WINDOWS.X64_193000_db_home\opsm\jlib\supercluster.jar
@set SUPERCLUSTER_COMMON_JAR=C:\WINDOWS.X64_193000_db_home\opsm\jlib\supercluster-common.jar
@set XMLPARSER2_JAR=C:\WINDOWS.X64_193000_db_home\lib\xmlparserv2.jar
@set NET_TOOLS_DIR=C:\WINDOWS.X64_193000_db_home\network\tools
@set NETCA_DOC_DIR=C:\WINDOWS.X64_193000_db_home\assistants\netca\doc
